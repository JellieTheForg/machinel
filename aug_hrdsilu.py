...
model = Sequential([
    Conv2D(32, (3, 3), activation='hard_silu', input_shape=(144, 144, 3)),
    MaxPooling2D((2, 2)),
    Conv2D(64, (5, 5), activation='hard_silu'),
    MaxPooling2D((2, 2)),
    Conv2D(128, (7, 7), activation='hard_silu'),
    MaxPooling2D((2, 2)),
    Conv2D(128, (9,9), activation='hard_silu'),
    MaxPooling2D((2,2)),
    Flatten(),
